...
const BridgeBar = ({ bridgeName, fromToken, toToken }: IBridgeBarProps) => {
  return (
    <div className="relative">
      <div className="mx-4 grid grid-cols-7 rounded-lg bg-wagpay-dark py-6 px-2 shadow sm:mx-auto sm:w-full sm:px-6">
        {/* left part */}
        <div className="col-span-2 flex items-start justify-center space-x-4">
          <div>
            <img src="/images/currency/usdcBadge.png" alt="usdc" />
          </div>
          <div className="flex flex-col space-y-1">
            <span className="text-sm text-white md:text-xl">0.00 USDC</span>
            <span className="text-xs text-white">On {fromToken}</span>
          </div>
        </div>
        {/* center part */}
        ...
        <div className="col-span-2 flex items-start justify-center space-x-4">
          ...
          <div className="flex flex-col space-y-1">
            <span className="text-sm text-white md:text-xl">0.00 USDC</span>
            <span className="text-xs text-white">On {toToken}</span>
          </div>
        </div>
      </div>
      {/* bottom pills */}
      <div className="absolute mx-4 mobile:w-full">
        <div className="flex items-center justify-center mobile:space-x-4">
          ...
          <div className="flex items-center space-x-2 rounded-b-xl bg-gray-300 px-4 py-1 text-sm">
            ...
            <span className="text-xs">$ 0.01 Gas Fee</span>
          </div>
          <div className="flex items-center space-x-2 rounded-b-xl bg-gray-300 px-4 py-1 text-sm">
            <svg
              xmlns="http://www.w3.org/2000/svg"
