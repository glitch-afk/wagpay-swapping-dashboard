      ...
      <Hero>
        <div className="flex min-h-full flex-col justify-center py-12 sm:px-6 lg:px-8">
          <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
            <div className="bg-wagpay-dark py-8 px-4 shadow sm:rounded-lg sm:px-6">
              {/* add here */}
              <div className="grid grid-cols-1 place-content-center gap-y-6 sm:grid-cols-7 sm:gap-y-0 sm:gap-x-2">
                <div className="sm:col-span-3">
                  ...
                  <select
                    id="sender"
                    name="sender"
                    className="mt-1 block w-full rounded-md py-2 text-wagpay-dark shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm"
                  >
                    <option />
                ...
                <div className="hidden  place-self-center pt-6 sm:col-span-1 sm:block">
                  <svg
              ...
              <div className="mt-6">
                <div className="relative">
                  ...
                  <div className="relative flex justify-center text-sm">
                    <span className="bg-wagpay-dark px-2 text-white">
                      Or continue with
                    </span>
                  </div>
                </div>
